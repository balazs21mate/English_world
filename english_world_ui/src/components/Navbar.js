...
function Navbar(props){
    ...
    return(
        <div className="w-screen fixed top-0 z-10 py-5 flex flex-col text-secondary_color bg-primary">
            <div className="flex justify-between w-[90%] mx-auto">
                ...
                <div className="hidden md:flex items-center text-2xl">
                    ...
                    <Link to="/grammar" className="text-nav_menu hover:text-nav_menu_hover transition-colors" href="/">Grammar</Link>
                </div>
            ...
            <div className={`${navbarMenu? "flex": "hidden"} flex-col items-start mt-5 md:hidden text-2xl`}>
